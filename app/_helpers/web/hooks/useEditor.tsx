  ...
  const init = async (data: any = {}, id: number | string = "", readonly = false, hasEditor = false, formWidth = 0) => {
    ...
    try {
      ...
      if (!Editorjs) {
        ...
        EmbedInputTool = await require("@/app/components/_Articles/EditorTools/EmbedInputTool").EmbedInputTool;
        HadithExplorerTool = await require("@/app/components/_Articles/EditorTools/HadithExplorerTool").HadithExplorerTool;
        QuranExplorerTool = await require("@/app/components/_Articles/EditorTools/QuranExplorerTool").QuranExplorerTool;
