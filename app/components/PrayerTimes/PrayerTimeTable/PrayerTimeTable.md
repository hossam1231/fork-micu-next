...
utes}m ${timeLeft.seconds}s`;

  };

  return (

    <div className="flex items-center justify-center p-4 rounded-md shadow-md hover:shadow-md hover:scale-105">

      <div className="flex items-center justify-center">

        <span className="text-slate-500 font-bold">{time.name}</span>

      </div>

      <div className="flex items-center justify-center">

        <span className="text-slate-500 font-bold">{calculateTimeLeft()}</span>
...
This code generates a Mermaid Markdown diagram for a Go application that displays the current prayer times for a specific location. The diagram consists of a table with columns for the name of the prayer, the start time, and the jamaat (congregation) time. The table also includes a button to edit the prayer times.
The `
