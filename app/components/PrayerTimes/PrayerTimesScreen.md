...
function PrayertimesScreen({ theme, showTopMessageEditor, showSubMessageEditor, showImageEditor, editOptions = null, images = [], onlyShowTimings = false, styles = {}, topMessage = "", subMessage = "", currentImage = 0, currentTime = new Date().toLocaleTimeString("en-US", { hour12: false, hour: "numeric", minute: "numeric", second: "numeric" }), nextPrayer = { name: "Fajr", time: "5:00" }, prayerTime = { fajr: true }, currentEstablishment = {} }) {
