...
Please note that this is just an example and you will need to modify it to fit your specific use case. Also, you will need to have the necessary dependencies installed, such as `hijri-date` and `mermaid`
