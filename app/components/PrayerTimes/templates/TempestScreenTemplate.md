...
<div className="flex flex-wrap">
                      {activity.map((activity) => (
                        ...
                        <div key={activity.id} className="flex-1 px-4 py-2 text-sm font-medium text-gray-400 hover:bg-gray-700 hover:text-white">

                          <div className="flex items-center justify-between">

                            <img src={activity.imageUrl} alt={activity.comment} className="w-8 h-8 rounded-full" />

                            <div className="ml-4">

                              <p>{activity.comment}</p>

                              <div className="text-sm font-medium text-gray-400">{activity.person.name}</div>
