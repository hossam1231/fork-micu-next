...
export const websiteURL = 'https://.mosque.icu'
// export const websiteURL = 'http://www.web.mosque.icu'

export const Tos = `Tailwind Terms of Service
...
If you do not want to agree to, or do not meet all of the eligibility requirements of, future revisions of this Agreement or the Privacy Policy, you may cease accessing or using the Services, and may contact us at help@tailwindapp.com to have your account(s) terminated.
...
Comply with the applicable terms of any Tailwind partners ("Our Partners") which you connect through the Services (the "Partner TOS"). These include, but are not limited to:
...
Free Trials. You must pay all fees for the Services you purchase, except for Services that we expressly offer free of charge. You may access a free trial of some of our services by visiting https://www.tailwindapp.com. This Agreement and our Privacy Policy applies to any Free Trial. Free Trials do not automatically switch to paid services.
...
Refunds. We do not provide refunds for all or part of pre-paid subscription terms. This includes, but is not limited to the following circumstances:
...
This Agreement, our Privacy Policy, Copyright Policy, and our Browser Extension Policy constitute the sole and entire agreement between you and Tailwind regarding the Services and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Services.

Your Comments and Concerns

This website is operated by BRIDESVIEW, INC. DBA TAILWIND, a Delaware Corporation having an address of 111 Harrison Ave, Oklahoma City, OK 73104. All notices of copyright infringement claims should be sent to the copyright agent designated in our Copyright Policy in the manner and by the means set out therein. All other feedback, comments, requests for technical support, and other communications relating to the Services should be directed to: help@tailwindapp.com. You may also submit comments and concerns via our chat interface inside the App and by calling us at (405) 702-9998.`
...
and all rights not expressly granted are reserved by Tailwind.
