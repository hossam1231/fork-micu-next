...
# Add Prayer
================
A simple Go web application for adding prayers
================
### Markdown Overview

This is a markdown overview for the `AddPrayer` Go file.

### Fields

The `AddPrayer` component has the following fields:

| Field Name | Type | Description |
| --- | --- | --- |
| `title` | `string` | Title of the prayer |
| `description` | `string` | Description of the prayer |
| `thumbnail` | `string` | URL of the thumbnail image for the prayer |
| `template` | `string` | Select a template for the prayer |

### Handlers

The `AddPrayer` component uses the following handlers:

| Handler Name | Description |
| --- | --- |
| `onSubmit` | Submits the prayer data to the server |

### States

The `AddPrayer` component has the following states:

| State Name | Description |
| --- | --- |
| `loading` | Whether the prayer is being processed by the server
