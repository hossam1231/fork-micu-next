...
* `element` {object} - The image element data
* `onChange` {function} - Callback for when the image URL or other properties change
* `showEditMenu` {boolean} - Whether to show the edit menu for the image
* `setShowEditMenu` {function} - Setter for the showEditMenu property
* `targetRef` {object} - The target reference for the image
* `setTransform` {function} - Setter for the transform property of the image

### Properties

* `isUrl` {boolean} - Whether the image URL is set
* `url` {string} - The image URL
* `altText` {string} - The alt text for the image
* `objectFit` {string} - The object fit style for the image (cover, contain, fill, none)
* `zindex` {number} - The z-index of the image

### Methods

* `setModel` {function} - Setter for the image element model
