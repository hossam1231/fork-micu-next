      ...
      style={
        position
          ? {
              ...
              left: window.innerWidth - position.x > 224 ? position.x : position.x - 225,
              position: "fixed",
              zIndex: 99999,
      ...
      {filteredItems().map((item: any) => {
        return (
          <div
            ...
            }  group-data-[disabled]:text-mauve8 hover-text-in group pointer-events-auto relative mt-1 flex h-[25px] cursor-pointer select-none items-center rounded-[3px] bg-transparent px-[5px] pl-[12px] text-[13px] font-medium leading-none outline-none backdrop-blur-3xl hover:text-indigo-500 hover:opacity-90
            `}
          >
