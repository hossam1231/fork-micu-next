  ...
  return (
    <>
      <div
        ...
        onClick={() => (text ? setSelectedAyah && word.audio_url && setSelectedAyah(word.verse_id) : setAudioUrl(audioUrl + word.audio_url))}
      >
        {text ? (
          <p
            data-tooltip-content={word.translation?.text + " | " + (word?.transliteration?.text || "")}
