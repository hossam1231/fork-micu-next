...
www.linkedin.com/shareArticle?mini=true&url=${window.location.href}&title=${article.title}&summary=${article.description}`} target="_blank" rel="noopener noreferrer">
        <img className="mx-1 h-6 w-6 hover:opacity-50" src="https://img.icons8.com/color/48/000000/linkedin--v1.png" alt="linkedin" />
      </a>
    </div>
...
Please note that the above code is just a syntax highlighting and not a working code. You will need to provide the actual Go code for the Mermaid Markdown syntax to work.
