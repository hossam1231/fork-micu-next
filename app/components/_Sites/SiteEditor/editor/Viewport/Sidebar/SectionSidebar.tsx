...
type Props = {
  setEditSectionIndex: (val: number) => void;
...
const SectionSidebar = ({ setEditSectionIndex, onDataChange, sidebarIndex, currentPage, siteData }: Props) => {
    ...
    <>
      {showFileSelector && (
        <FileSelectorModal
          ...
          onFileSelect={(file: { url: any }) => {
            onDataChange({
              ...currentPage?.content[sidebarIndex]?.data,
              imageUrl: file.url,
            });
              ...
              <FormGroup
                ...
                fields={[
...

                  {
                    ...
                    type: "input",
                    maxLength: 1000,
                    hidden: ({ model }: any) => model.backgroundType !== "link",
                  },
                  {
                    ...
                    subType: "color",
                    className: "w-[140px]",
                    presetColors: siteData.siteColors,
                    wrapperHorizontal: true,
                    hidden: ({ model }: any) => model.backgroundType !== "color",
                  },
                  {
                    type: "custom",
                    name: "file",
                    component: ({ model }) => (
                      ...
                      >
                        {model.imageUrl ? "Replace image" : "Select image"}
                      </Button>
                    ),
                    hidden: ({ model }: any) => model.backgroundType !== "image",
                  },
                  {
                    type: "custom",
                    name: "file_preview",
                    component: ({ model }) => (
                      <img
                        ...
                        src={model.backgroundType === "image" ? model.imageUrl : model.backgroundImage || ""}
                        alt={model.altText || "Image"}
                      />
                    ),
                    hidden: ({ model }) => model.backgroundType !== "image" && model.backgroundType !== "link",
                  },
              ...
              <FormGroup
                ...
                fields={[
...

                  {
                    ...
                    presetColors: siteData.siteColors,
                    wrapperHorizontal: true,
                    hidden: ({ model }: any) => !model.borderType,
                  },
                  {
                    name: "borderWidth",
                    label: "Border Width",
                  ...
                  },
                  {
                    ...
                    max: 10,
                    wrapperHorizontal: true,
                    hidden: ({ model }: any) => !model.boxShadow,
                  },
                ]}
                model={currentPage?.content[sidebarIndex]?.data || {}}
                setModel={function (model: any): void {
              ...
              <FormGroup
                ...
                fields={[
                  ...
                  },
                  {
                    ...
                    className: "w-[140px]",
                    wrapperHorizontal: true,
                    hidden: ({ model }: any) => model.padding !== "full",
                  },
                  {
                    name: "paddingTop",
                    ...
                    wrapperHorizontal: true,
                    subType: "number",
                    hidden: ({ model }: any) => model.padding !== "side",
                  },
                  {
                    name: "paddingRight",
...

                  {
                    ...
                    className: "w-[140px]",
                    wrapperHorizontal: true,
                    hidden: ({ model }: any) => model.margin !== "full",
                  },
                  {
                    name: "marginTop",
                    label: "Margin top (px)",
                    ...
                    className: "w-[140px]",
                    wrapperHorizontal: true,
                    hidden: ({ model }: any) => model.margin !== "side",
                  },
                  {
                    name: "marginRight",
              ...
              <FormGroup
                ...
                fields={[
                  ...
                  },
                  {
                    ...
                    max: 10,
                    step: 0.1,
                    hidden: ({ model }: any) => !model.animation,
                  },
