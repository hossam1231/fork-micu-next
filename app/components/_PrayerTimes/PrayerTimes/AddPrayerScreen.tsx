...
function AddPrayerScreen({ close, setCurScreens, establishmentPublicId }: Props) {
  const [model, setModel] = React.useState({ ...defaultModel });
  const [loading, setLoading] = React.useState(false);

  const onSubmit = async (data: { images: string; thumbnail: any; establishmentPublicId: string }) => {
    setLoading(true);
