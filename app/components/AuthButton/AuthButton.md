...
graph LR
    ...
    | User from 'react-feather'     |
        +-------------------------------+
    | Import Statements from '@redwoodjs/auth' |
        +-------------------------------+
    | Import Statements from '@redwoodjs/router' |
        +-------------------------------+
    | Import Statements from '@redwoodjs/web' |
        +-------------------------------+
    | Import Statements from '@redwoodjs/web/toast' |
        +-------------------------------+
