...
class Editor extends Component {
  ...
  render() {
    return (
      <>
        <div
          data={this.props.element.data?.color ? "background" : ""}
          style={{
            ...
            height: "fit-content",
            padding: this.props.element?.data?.padding ? this.props.element?.data?.padding + "px" : "50px",
            margin: this.props.element?.data?.margin ? this.props.element?.data?.margin + "px" : "0px",
          }}
