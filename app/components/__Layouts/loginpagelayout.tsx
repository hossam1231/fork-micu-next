            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                <div>
                  ...
                  <DynamicText
                    wordsStyle={"text-4xl font-bold tracking-tight text-black sm:text-5xl md:text-6xl"}
                    sentenceStyle={"text-4xl font-bold tracking-tight text-black sm:text-5xl md:text-6xl"}
                  ...
                  <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    Our mission, to enable you to leverage technology without requiring any technical expertise.
                  </p>
                  <p className="mt-8 text-base font-semibold text-black sm:mt-10">Used by</p>
