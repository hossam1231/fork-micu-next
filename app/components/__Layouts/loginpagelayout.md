...
```mermaid
      ...
      <Popover
        className=" absolute top-0 right-0 transform z-10 sm:absolute sm:top-6 sm:right-6"
        placement="bottom"
        isOpen={isOpen}
        onHide={() => setIsOpen(false)}
        onShow={() => setIsOpen(true)}
        arrow={<XMarkIcon className="text-2xl" />}
        content={
          <div className="bg-white shadow-inner rounded-md">
            <div className="px-6 py-8 sm:px-10">
