...
import { BriefcaseIcon, ChevronDownIcon, CloudArrowDownIcon, CloudArrowUpIcon, PlusIcon } from "@heroicons/react/20/solid";
...
import Prayers from "@/app/components/_PrayerTimes/Prayers/Prayers";
        ...
        <header className="bg-gray-50 mb-20 p-8 rounded-full">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
            <div className="min-w-0 flex-1">
              <h1 className="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Prayers</h1>
              <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-8">
                <p className="mt-2 flex items-center text-sm text-gray-500">
                  <BriefcaseIcon className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" aria-hidden="true" />A schedule of
                ...
                button={
                  <span className="ml-3 hidden sm:block">
                    <button
                      ...
                      className="inline-flex items-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                    >
                      <CloudArrowDownIcon className="-ml-0.5 h-5 w-5 text-gray-400" aria-hidden="true" />
                      Import
                    </button>
                  </span>
                }
