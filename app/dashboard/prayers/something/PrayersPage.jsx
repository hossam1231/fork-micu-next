      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h1 className="text-3xl font-semibold leading-6 text-gray-900">Prayers</h1>
            <div className="flex">
              ...
              <p className="mt-2 flex text-sm text-gray-700">prayers conducted at the mosque.</p>
            </div>
          </div>
        ...
        <div>
          <div className="flex flex-wrap items-center mt-10 gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
            <h1 className="text-base font-semibold leading-7 text-gray-900">Duration</h1>
