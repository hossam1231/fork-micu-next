  ...
  return (
    <div>
      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog style={{ zIndex: 1000 }} as="div" className="relative z-10" onClose={setOpen}>
                      ...
                      <div className="h-0 flex-1 overflow-y-auto">
                        <div className="bg-indigo-700 px-4 py-6 sm:px-6">
                          <div className="flex items-center justify-between">
                            <Dialog.Title className="text-base font-semibold leading-6 text-white">New Prayer</Dialog.Title>
                          ...
                          <div className="mt-1">
                            <p className="text-sm text-indigo-300">Get started by filling in the information below to create your new prayer.</p>
                          </div>
                        </div>
