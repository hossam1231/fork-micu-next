...
import { CloudArrowDownIcon, CloudArrowUpIcon, UsersIcon } from "@heroicons/react/24/outline";
                  ...
                  <>
                    <div className="md:flex md:items-center p-5 md:justify-between">
                      <div className="min-w-0 flex-1">
                        <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Import prayers</h2>
                      </div>
                    ...
                    <Combobox.Options as="div" static hold className="flex divide-x divide-gray-100">
                      <div className={classNames("max-h-96 min-w-0 flex-auto scroll-py-4 overflow-y-auto px-6 py-4", "sm:h-96")}>
                        <h2 className="mb-4 mt-2 text-xs font-semibold text-gray-500">Various methods</h2>
                        <div className="-mx-2 text-sm text-gray-700">
                          <Combobox.Option
                            as="div"
                            value={"hello"}
                            className={({}) => classNames("flex cursor-default select-none items-center rounded-md p-2", "bg-gray-100 text-gray-900")}
                          >
                            <>
                              <img alt="" className="h-6 w-6 flex-none rounded-full" />
                      ...
                      <>
                        ...
                        <div className="hidden h-96 w-1/2 flex-none flex-col divide-y divide-gray-100 overflow-y-auto sm:flex">
                          <div className="flex-none p-6 text-center">
                            <img alt="" className="mx-auto h-16 w-16 rounded-full" />
                    ...
                    <div className="px-6 py-14 text-center text-sm sm:px-14">
                      <CloudArrowUpIcon className="mx-auto h-6 w-6 text-gray-400" aria-hidden="true" />
                      <p className="mt-4 font-semibold text-gray-900">Drag and drop</p>
                      <p className="mt-2 text-gray-500">Drop your file here to import easily</p>
                    </div>
                  </>
                </Combobox>
              </Dialog.Panel>
