...
font-medium text-gray-900">Choose file</h2>
                  <input
                    type="file"
                    className="block w-full p-2 text-gray-700"
...
```
```
Please note that this is just an example and you may need to modify it to fit your specific use case. Also, the `niceBytes` function is not included in the example, you can find it in the `utils` module of the `
