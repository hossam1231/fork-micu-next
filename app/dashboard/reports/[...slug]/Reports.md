...
aria-hidden='true'
						...
						<div className='flex items-center justify-between mt-4 sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-8'>
						<button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded' type='button'>
							Save
						</button>
						<button className='bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-6 rounded' type='button'>
							Discard
						</button>
					</div>
			...
			<div className='flex flex-col justify-center lg:flex-grow lg:justify-between
