                            ...
                            <tr key={transaction.id}>
                              ...
                              <td className="py-5 text-right">
                                <div className="flex justify-end">
                                  <a href={transaction.href} className="text-sm font-medium leading-6 text-indigo-600 hover:text-indigo-500">
                                    View
...
export default function page({ orgUsers }: any) {
  ...
  return (
    <SideBarLayout currentEstablishment={currentEstablishment} loading={loading}>
      <div>
        <Example />
      </div>
    </SideBarLayout>
