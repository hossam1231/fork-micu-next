...
link to access your personal information.
								</p>
								...
								<form>
									...
									Name</label>
								<input type='text' id='name' className='block w-full p-2 text-gray-700 border border-gray-300 rounded-md' />

									<label htmlFor='email' className='block text-sm font-medium'>
									Email</label>
								<input type='email' id='email' className='block w-full p-2 text-gray-700 border border-gray-300 rounded-md' />

									<button type='submit' className='w-full flex items-center justify-center p-2 text-white font
