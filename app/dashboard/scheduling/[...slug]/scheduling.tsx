      ...
      <header className="bg-gray-50 p-8 rounded-full">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
          <div className="min-w-0 flex-1">
            <h1 className="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Scheduling</h1>
...
export default function SchedulingPage({ data }: any) {
